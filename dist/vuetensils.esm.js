...
var __vue_staticRenderFns__$3 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-7a2659c2_0", { source: ".vts-file__input{position:absolute;overflow:hidden;clip:rect(0 0 0 0);width:1px;height:1px;margin:-1px;border:0;padding:0}.vts-file__dropzone{position:relative;box-sizing:border-box;border:1px solid;padding:2px}.vts-file__overlay{position:absolute;top:0;right:0;bottom:0;left:0}input:focus~.vts-file__dropzone{outline-width:1px;outline-style:auto;outline-color:Highlight;outline-color:-webkit-focus-ring-color}", map: undefined, media: undefined });
