...
export function bind(el, { value, modifiers }) {
  ...
  el.addEventListener("mouseover", e => {
    const { offsetTop, offsetLeft, offsetWidth: elW, offsetHeight: elH } = el
    const { offsetWidth: ttW, offsetHeight: ttH } = tooltip
    ...
    // TODO
    // el.setAttribute("aria-describedby", "test")

    // <div role="tooltip" id="tooltip_sl698dhh9c" aria-hidden="true" x-placement="top" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(366px, 500px, 0px); display: none;"><div class="tooltip-arrow" style="left: 57px;"></div><div class="tooltip-inner">This is a button.</div></div>
  })
  ...
  //     liveRegion.innerHTML = '<span class="el-bubble">' + message + "</span>"
  //   }, 100)
  // })
